...
public class Database extends SQLiteAssetHelper {
    ...
    public void insert_patient_id_test(String patient_ID){
    ...
    public void update_no2(String patient_ID,String no2_1,String no2_2,String no2_3,String no2_4,String no2_5,int sumscore){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues Val = new ContentValues();
        Val.put("no2_1",no2_1);
        Val.put("no2_2",no2_2);
    ...
    public ArrayList<String> get_no2(String patient_id){
        ArrayList<String> get_no2 = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery("select no2_1,no2_2,no2_3,no2_4,no2_5,sum_score2 from Test where patient_ID = " + patient_id,null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
    ...
    public void update_no3(String patient_ID,String no3_1,String no3_2,String no3_3,int sumscore){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues Val = new ContentValues();
        Val.put("no3_1",no3_1);
        Val.put("no3_2",no3_2);
    ...
    public ArrayList<String> get_no3(String patient_id){
        ArrayList<String> get_no3 = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery("select no3_1,no3_2,no3_3,sum_score2 from Test where patient_ID = " + patient_id,null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
    ...
    public void update_no4(String patient_ID,String no4_1,String no4_2,String no4_3,String no4_4,String no4_5,int sumscore,String sumstring){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues Val = new ContentValues();
        Val.put("no4_1",no4_1);
        Val.put("no4_2",no4_2);
    ...
    public ArrayList<String> get_no4(String patient_id){
        ArrayList<String> get_no4 = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery("select no4_1,no4_2,no4_3,no4_4,no4_5,sum_string_4_2,sum_score4 from Test where patient_ID = " + patient_id,null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
    ...
    public void update_no5(String patient_ID,String no5_1,String no5_2,String no5_3,int sumscore){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues Val = new ContentValues();
        Val.put("no5_1",no5_1);
        Val.put("no5_2",no5_2);
    ...
    public ArrayList<String> get_no5(String patient_id){
        ArrayList<String> get_no5 = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery("select no5_1,no5_2,no5_3,sum_score5 from Test where patient_ID = " + patient_id,null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
    ...
    public void update_no6(String patient_ID,String no6_1,String no6_2,int sumscore){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues Val = new ContentValues();
        Val.put("no6_1",no6_1);
        Val.put("no6_2",no6_2);
    ...
    public ArrayList<String> get_no6(String patient_id){
        ArrayList<String> get_no6 = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery("select no6_1,no6_2,sum_score6 from Test where patient_ID = " + patient_id,null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
    ...
    public void update_no7(String patient_ID,String no7_1,int sumscore){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues Val = new ContentValues();
        Val.put("no7_1",no7_1);
    ...
    public ArrayList<String> get_no7(String patient_id){
        ArrayList<String> get_no7 = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery("select no7_1,sum_score7 from Test where patient_ID = " + patient_id,null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
    ...
    public void update_no8(String patient_ID,String no8_1,String no8_2,String no8_3,String place8,int sumscore){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues Val = new ContentValues();
        Val.put("no8_1",no8_1);
        Val.put("no8_2",no8_2);
    ...
    public ArrayList<String> get_no8(String patient_id){
        ArrayList<String> get_no8 = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery("select no8_1,no8_2,no8_3,place8,sum_score8 from Test where patient_ID = " + patient_id,null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
    ...
    public void update_no9(String patient_ID,String no9_1,int sumscore){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues Val = new ContentValues();
        Val.put("no9_1",no9_1);
    ...
    public ArrayList<String> get_no9(String patient_id){
        ArrayList<String> get_no9 = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery("select no9_1,sum_score9 from Test where patient_ID = " + patient_id,null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
    ...
    public void update_no10(String patient_ID,String no10_1,String path_picture,int sumscore){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues Val = new ContentValues();
    ...
    public ArrayList<String> get_no10(String patient_id){
        ArrayList<String> get_no11 = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery("select no10_1,no10_path_picture,sum_score10 from Test where patient_ID = " + patient_id,null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
    ...
    public void update_no11(String patient_ID,String no11_1,String path_picture,int sumscore){
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues Val = new ContentValues();
    ...
    public ArrayList<String> get_no11(String patient_id){
        ArrayList<String> get_no11 = new ArrayList<>();
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.rawQuery("select no11_1,no11_path_picture,sum_score11 from Test where patient_ID = " + patient_id,null);
        cursor.moveToFirst();
        while (!cursor.isAfterLast()){
            get_no11.add(cursor.getString(0));
            get_no11.add(cursor.getString(1));
